...
class Product(models.Model):
    ...
    price = MoneyField(max_digits=14, decimal_places=2, default_currency='INR', verbose_name="Price (₹)")    
...
def __str__(self):
    # Only get the amount without currency
    return f"{self.title} - ₹{self.price.amount}"
